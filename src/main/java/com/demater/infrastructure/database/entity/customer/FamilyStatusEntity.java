...
@Entity
@Table(name = FamilyStatusEntity.TABLE_NAME)
@Access(AccessType.FIELD)
public class FamilyStatusEntity extends CodeNameAbstractEntity {
    public static final String TABLE_NAME = "family_status";
