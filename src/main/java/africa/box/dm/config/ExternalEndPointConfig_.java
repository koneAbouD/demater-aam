...
public class ExternalEndPointConfig_ {
    public static final String BASE_URL = "http://172.16.1.146:8080";
     ...
     */
    public static final String URL_UPDATE_BUSINESSKEY = BASE_URL+"/api/account/uuid/update";
     ...
     */
    public static final String URL_GET_DOCS = BASE_URL+"/api/account/docs/getter";
