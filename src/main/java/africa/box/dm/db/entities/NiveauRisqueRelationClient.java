...
@ToString
@Entity
@Table(name = NiveauRisqueRelationClient.TABLE_NAME)
@Access(AccessType.FIELD)
public class NiveauRisqueRelationClient {
    public static final String TABLE_NAME = "niveau_risque_relation_client";
