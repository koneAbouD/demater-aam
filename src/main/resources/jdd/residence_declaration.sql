...
VALUES
    ...
    (nextval('residence_declaration_id_seq'), '004', 'Autres pays de la zone franc'),
    (nextval('residence_declaration_id_seq'), '005', 'Autres états membre de la CEDEAO'),
    (nextval('residence_declaration_id_seq'), '006', 'Zone euro, autres états');